...
//                .build();
        return http
                .csrf(customizer -> customizer.disable())
                .authorizeRequests(requests -> requests.requestMatchers("/api/car/**","/api/user","/login","api/register","api/client/**","api/showroom/**","api/cart/**","api/payment/**").permitAll().anyRequest().authenticated())
