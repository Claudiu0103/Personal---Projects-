...
public class CarConfig {
    ...
    CommandLineRunner commandLineRunner(CarRepository repository, UserRepository userRepository, AdminRepository adminRepository, ShowroomRepository showroomRepository) {
        return args -> {
            ...
            Car BMW = new Car(2, 280000, "21-05-2010", "BWM 3 Series ", "Sedan", 12000, "White", showroom);
            Car Mercedes = new Car(3, 300000, "10-03-2012", "Mercedes C-Class", "Sedan", 16000, "White", showroom);
            Car Volkswagen = new Car(4, 250000, "15-07-2016", "Volkswagen Passat", "Sedan", 12000, "Grey", showroom);
